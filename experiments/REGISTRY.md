...
| DEMO-0001 | **Monte Carlo recovery of a closed-form detection probability** | infrastructure | — | **`COMPLETED`** | Framework demonstration — PASS path (all 10 gates) | [package](../results/DEMO-0001/report.md) |
| DEMO-0002 | **Deliberately invalid run — outside the model validity envelope** | infrastructure | — | **`INVALID`** | Framework demonstration — FAIL path; `FAIL-0002`; no conclusion emitted | [package](../results/DEMO-0002/report.md) |
| — | **TV-N1 blocking literature & novelty audit** | foundational | — | **`COMPLETED`** | **`NOVELTY GATE: FAIL`** | [audit](../research/literature/TV-N1_LITERATURE_AUDIT.md) · [evidence](../research/literature/TV-N1_EVIDENCE_MATRIX.md) · [novelty](../research/literature/TV-N1_NOVELTY_MATRIX.md) |
| EXP-0013 | Excitation-limited identifiability of near-manifold faults | exploratory | H2 | **`CANCELLED`** | **Cancelled by TV-N1: solved in the literature** (Scott et al. 2014 *Automatica*; Raimondo et al. 2016; Kong et al. 2025 Lemma 1) | — |
